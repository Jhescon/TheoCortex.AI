        ...
        <div className="section-container relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between mb-16 md:space-x-12">
            ...
            <div className="flex items-center space-x-8 mb-8 md:mb-0">
              ...
              <a href="/#about" className="nav-link text-sm footer-nav-link" onClick={() => window.location.href = '/#about'}>About</a>
              <a href="/#how-it-works" className="nav-link text-sm footer-nav-link" onClick={() => window.location.href = '/#how-it-works'}>
